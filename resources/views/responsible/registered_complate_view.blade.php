...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <form action="{{route('registered_complate_view2',$user->id)}}"  style="margin:15px" method="post" class="form-group">
            @csrf @method('patch')
            <a >
                ...
                <div class="row col-md-12 ">
                    ...
                    <div class="row" style="margin-top: 20px; ">
                        <div class="row col-md-12">
                            ...
                            <div style="display: flex" class="form-group">
                                زنده<input type="radio" name="father_death" value="1" @if(old('father_death',$user->father_death) == '1') checked @endif>
                                مرده<input type="radio" name="father_death"  value="0" @if(old('father_death',$user->father_death) == '0') checked @endif>
                            </div>
                        </div>
                    </div>
                    <a >
                    ...
                    <div class="row" style="margin-top: 20px; ">
                        <div class="row col-md-12">
                            ...
                            <div style="display: flex" class="form-$user->mother_jobgroup">
                                زنده<input type="radio" name="mother_death" value="1"  @if(old('mother_death',$user->mother_death) == '1') checked @endif>
                                مرده<input type="radio" name="mother_death"  value="0"  @if(old('mother_death',$user->mother_death) == '0') checked @endif>
                            </div>
                        </div>
                    </div>
                    <div class="row">
