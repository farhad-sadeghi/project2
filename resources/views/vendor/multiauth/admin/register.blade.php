...
<div class="container">
    ...
    @include('multiauth::message')
                    <form method="POST" action="{{ route('admin.register') }}">
                        ...
                        <div class="form-group{{ $errors->has('ninja_code') ? ' has-error' : '' }} row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">ninja_code</label>

                            <div class="col-md-6">
                                <input id="ninja_code" type="text" class="form-control{{ $errors->has('ninja_code') ? ' is-invalid' : '' }}" name="ninja_code" value="{{ old('ninja_code') }}"
                                       required>
                            </div>
                        </div>
